...
@Component({
  selector: "app-trainig-sessions",
  templateUrl: "./trainig-sessions.component.html",
  styleUrls: ["./trainig-sessions.component.css"],
})
export class TrainigSessionsComponent implements OnInit {
  categories = [];
  search: any;
  msgError: any;
  constructor(
